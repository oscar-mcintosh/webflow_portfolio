  ...
  <div class="contact__container container grid section__border">
    ...
    <div class="contact__content">
      <h3 class="contact__title">
        <i class="ri-send-plane-line"></i>If you have a project or need help,
        contact me.
      </h3>
      <form
      ...
      <div class="contact__form-message" v-if="showSuccessMessage">
        <h3 class="contact__form-success">
          Thank you for contacting Two-Forty-Two Dev! We'll respond to you
...
const submitForm = async () => {
  ...
  try {
    ...
    if (response && (response.status === 200 || response.success)) {
      result.value =
        "Thank you for contacting TwoFortyTwo Dev! We'll respond to you within two business days";
      ...
      result.value =
        response?.message || "No response received from the server.";
      status.value = "error";
    }
  } catch (error) {
